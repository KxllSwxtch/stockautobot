...
def handle_message(message):
    ...
    # Проверка на другие команды
        ...
        about_message = (
            "🔹 <b>Почему выбирают Сток Авто?</b>\n\n"
            "🚗 <b>Экспертный опыт</b> — Мы знаем все нюансы подбора и доставки авто из Южной Кореи.\n\n"
            "🎯 <b>Индивидуальный подход</b> — Учитываем все пожелания клиентов, подбираем оптимальный вариант.\n\n"
            "🔧 <b>Комплексное обслуживание</b> — Полное сопровождение на всех этапах сделки.\n\n"
